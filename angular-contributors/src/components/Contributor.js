...
const Contributor = () => {
    const {id} = useParams();
    const {data, loading} = useFetch(`https://api.github.com/users/${id}`)
                ...
                <div className="content">
                    <div className="info">
                        ...
                        <div className="buttons">
                            <Link to="/" className="button light-b">Pin Profile</Link>
                            <Link to="/" className="button">Connect</Link>
                        </div>
                        <p className="location">
                            <span><i className="fas fa-map-marker-alt"></i></span> {data.location}
                        </p>
                    </div>
                    <div className="recents">
                        <div className="heading">
                            ...
                            <p>
                                <span><i className="fas fa-sort"></i></span>Date Created
                            </p>
                        </div>
                        <div>
